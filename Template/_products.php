                    ...
                    <div class="row">
                        ...
                        <?php } ?>
                            ...
                            <form action="" method="POST"> 
                             ...
                             <div class="qty d-flex">
                                         ...
                                         <div class="px-4 d-flex font-rale">
                                             ...
                                             <input type="text" data-id="pro1" class="qty_input border px-2 w-50 bg-light" disabled value="1" placeholder="Give Star Rating">
                              ...
                              <form method="post">
                                  ...
                                  Enter rating <input type="text" name="rating" value="<?php echo $item['rating'] ?? '1'; ?>">     
                              ...
                              <form action='_cart-template.php' method='post'>
                            ...
                            <div class="card-deck" style="padding-top:10px;">
                              ...
                              <div class="card text-white mb-1" style="background:#37475A">                               
                                <div class="card-body">
                                  <h5 class="card-title">Airing Dates</h5>

...
<!-- !Shopping cart section  -->
<center>-----------------Your latest rating is <?php echo $item['rating']; ?> stars-----------------------</center>
              ...
              <div class="row gutters-sm">
                ...
                <div class="col-sm-6 mb-3">
                  <div class="card h-100">
                    <div class="card-body">
                      <center>
                      <h3 class="d-flex align-items-center mb-3"><i class="material-icons text-info mr-2" style="padding-right:70px;"></i>More Info</h3>
                      <div style="padding-top:5px;">
                        <h5>Total entries: <?php echo isset($subTotal) ? count($subTotal) : 0; ?> &nbsp; </h5>
                        <span>Your Average Rating: <?php echo isset($subTotal) ? round(($Cart->getSum($subTotal)/(count($subTotal))),2,PHP_ROUND_HALF_UP) : 0; ?></span> </span> </h5>
